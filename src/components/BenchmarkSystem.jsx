...
// This is a more detailed scoring system based on estimated real-world performance.
// In a production environment, these would be based on actual benchmark results.
...
const BenchmarkSystem = ({ selectedComponents }) => {
  ...
  useEffect(() => {
    const calculateBenchmarks = () => {
      ...
      const ram = componentScores.RAM[selectedComponents.RAM?.split(' ')[0]] || { bandwidth: 0, capacity: 0 };
